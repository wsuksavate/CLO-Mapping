...
## Set column names dynamically based on the matrix shape
num_plos = plo_df.shape[1]
plo_columns = [f'PLO{i+1}' for i in range(num_plos)]
plo_df.columns = plo_columns
plo_cont_df.columns = plo_columns
...
### Revised to have variable PLO
# 3. Setup the plot
# Generate a dynamic presentation-ready plot with explicit white background
