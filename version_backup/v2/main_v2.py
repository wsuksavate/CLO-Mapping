...
# Function to map letter grades to numerical scores (proportion of credits to achieves)
def map_grades(grade):
    if grade == 'A':
        ...
        return 0.0  # If student do not enroll the course
...
for i in range(len(df)):
    ...
    if i == 0:
        plt.title('The Reference Scores \n *Percentage calculated from the total of all available courses*')
